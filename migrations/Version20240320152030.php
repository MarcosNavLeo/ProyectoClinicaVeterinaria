 ...
 */
final class Version20240320152030 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE tratamientos (id INT AUTO_INCREMENT NOT NULL, desc_tratamiento VARCHAR(255) NOT NULL, fecha_tratamiento DATE NOT NULL, duracion VARCHAR(100) NOT NULL, costo DOUBLE PRECISION NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
